...
generateRandomString(length = 50) {
...
@Post('encryption')
  encryptDataWithPublicKey(@Body() data: any): string {
    const pgPublicKey =
 ...
 async generateSignature(@Req() req: Request) {
    try {
     const pgprivateKey =' '
      ...
      // Convert the plain sensitive data to a string
      const plainSensitiveData = JSON.stringify(req.body);
      console.log(plainSensitiveData);
      // Create the signature using SHA1withRSA algorithm
      const signer = crypto.createSign('RSA-SHA1');
      signer.update(plainSensitiveData);
...
@Post('decrypt')
async decrypt(@Req() req:Request) {
  try {
    const pgprivateKey = ''; // Replace with your actual private key
    const mar_pri_key = `-----BEGIN PRIVATE KEY-----\n${pgprivateKey}\n-----END PRIVATE KEY-----`;
